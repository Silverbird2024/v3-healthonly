...
NeoApp.controller("page1_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 1;
$App.NAB.PageID = "page1";
$scope.TextInput2_change = function() {localStorage.setItem("nsd",$App.nsd);};
$scope.TextInput1_change = function() {localStorage.setItem("che",$App.che);};
$scope.TextInput3_change = function() {localStorage.setItem("tum",$App.tum);};
$scope.TextInput4_change = function() {localStorage.setItem("llu",$App.llu);};
$scope.TextInput5_change = function() {localStorage.setItem("lru",$App.lru);};
$scope.TextInput6_change = function() {localStorage.setItem("alu",$App.alu);};
$scope.TextInput7_change = function() {localStorage.setItem("aru",$App.aru);};
$scope.TextInput9_change = function() {localStorage.setItem("ws",$App.ws);};
$scope.TextInput10_change = function() {localStorage.setItem("wp",$App.wp);};
$scope.TextInput8_change = function() {localStorage.setItem("hf",$App.hf);};
$scope.TextInput11_change = function() {localStorage.setItem("hi",$App.hi);};
$scope.TextInput23_change = function() {localStorage.setItem("bp",$App.bp);};
$scope.TextInput24_change = function() {localStorage.setItem("bs",$App.bs);};
$scope.PushButton1_click = function() {$App.save001 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save001",$App.save001);
localStorage.setItem("hi1",$App.hi);
localStorage.setItem("hf1",$App.hf);
localStorage.setItem("ws1",$App.ws);
localStorage.setItem("wp1",$App.wp);
localStorage.setItem("nsd1",$App.nsd);
localStorage.setItem("che1",$App.che);
localStorage.setItem("tum1",$App.tum);
localStorage.setItem("llu1",$App.llu);
localStorage.setItem("lru1",$App.lru);
...
$App.hi = localStorage.getItem("hi1");
$App.hf = localStorage.getItem("hf1");
$App.ws = localStorage.getItem("ws1");
$App.wp = localStorage.getItem("wp1");
$App.nsd = localStorage.getItem("nsd1");
$App.che = localStorage.getItem("che1");
$App.tum = localStorage.getItem("tum1");
$App.llu = localStorage.getItem("llu1");
$App.lru = localStorage.getItem("lru1");
$App.aru = localStorage.getItem("aru1");
$App.alu = localStorage.getItem("alu1");
$App.bp = localStorage.getItem("bp1");
$App.bs = localStorage.getItem("bs1");};
$scope.PushButton3_click = function() {$App.save002 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save002",$App.save002);
localStorage.setItem("hi2",$App.hi);
localStorage.setItem("hf2",$App.hf);
localStorage.setItem("ws2",$App.ws);
localStorage.setItem("wp2",$App.wp);
localStorage.setItem("nsd2",$App.nsd);
localStorage.setItem("che2",$App.che);
localStorage.setItem("tum2",$App.tum);
localStorage.setItem("llu2",$App.llu);
localStorage.setItem("lru2",$App.lru);
localStorage.setItem("aru2",$App.aru);
localStorage.setItem("alu2",$App.alu);
localStorage.setItem("bs2",$App.bs);
localStorage.setItem("bp2",$App.bp);};
$scope.PushButton4_click = function() {$App.recall = "2";
$App.save002 = localStorage.getItem("save002");
$App.recall2 = $App.save002;
$App.hi = localStorage.getItem("hi2");
$App.hf = localStorage.getItem("hf2");
$App.ws = localStorage.getItem("ws2");
$App.wp = localStorage.getItem("wp2");
$App.nsd = localStorage.getItem("nsd2");
$App.che = localStorage.getItem("che2");
$App.tum = localStorage.getItem("tum2");
$App.llu = localStorage.getItem("llu2");
$App.lru = localStorage.getItem("lru2");
$App.aru = localStorage.getItem("aru2");
$App.alu = localStorage.getItem("alu2");
$App.bp = localStorage.getItem("bp2");
$App.bs = localStorage.getItem("bs2");};
$scope.PushButton5_click = function() {$App.save003 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save003",$App.save003);
localStorage.setItem("hi3",$App.hi);
localStorage.setItem("hf3",$App.hf);
localStorage.setItem("ws3",$App.ws);
localStorage.setItem("wp3",$App.wp);
localStorage.setItem("nsd3",$App.nsd);
localStorage.setItem("che3",$App.che);
localStorage.setItem("tum3",$App.tum);
localStorage.setItem("llu3",$App.llu);
localStorage.setItem("lru3",$App.lru);
localStorage.setItem("aru3",$App.aru);
localStorage.setItem("alu3",$App.alu);
localStorage.setItem("bs3",$App.bs);
localStorage.setItem("bp3",$App.bp);};
$scope.PushButton6_click = function() {$App.recall = "3";
$App.save003 = localStorage.getItem("save003");
$App.recall2 = $App.save003;
$App.hi = localStorage.getItem("hi3");
$App.hf = localStorage.getItem("hf3");
$App.ws = localStorage.getItem("ws3");
$App.wp = localStorage.getItem("wp3");
$App.nsd = localStorage.getItem("nsd3");
$App.che = localStorage.getItem("che3");
$App.tum = localStorage.getItem("tum3");
$App.llu = localStorage.getItem("llu3");
$App.lru = localStorage.getItem("lru3");
$App.aru = localStorage.getItem("aru3");
$App.alu = localStorage.getItem("alu3");
$App.bp = localStorage.getItem("bp3");
$App.bs = localStorage.getItem("bs3");};
$scope.PushButton7_click = function() {$App.save004 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save004",$App.save004);
localStorage.setItem("hi4",$App.hi);
localStorage.setItem("hf4",$App.hf);
localStorage.setItem("ws4",$App.ws);
localStorage.setItem("wp4",$App.wp);
localStorage.setItem("nsd4",$App.nsd);
localStorage.setItem("che4",$App.che);
localStorage.setItem("tum4",$App.tum);
localStorage.setItem("llu4",$App.llu);
localStorage.setItem("lru4",$App.lru);
localStorage.setItem("aru4",$App.aru);
localStorage.setItem("alu4",$App.alu);
localStorage.setItem("bs4",$App.bs);
localStorage.setItem("bp4",$App.bp);};
$scope.PushButton8_click = function() {$App.recall = "4";
$App.save004 = localStorage.getItem("save004");
$App.recall2 = $App.save004;
$App.hi = localStorage.getItem("hi4");
$App.hf = localStorage.getItem("hf4");
$App.ws = localStorage.getItem("ws4");
$App.wp = localStorage.getItem("wp4");
$App.nsd = localStorage.getItem("nsd4");
$App.che = localStorage.getItem("che4");
$App.tum = localStorage.getItem("tum4");
$App.llu = localStorage.getItem("llu4");
$App.lru = localStorage.getItem("lru4");
$App.aru = localStorage.getItem("aru4");
$App.alu = localStorage.getItem("alu4");
$App.bp = localStorage.getItem("bp4");
$App.bs = localStorage.getItem("bs4");};
$scope.PushButton9_click = function() {$App.save005 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save005",$App.save005);
localStorage.setItem("hi5",$App.hi);
localStorage.setItem("hf5",$App.hf);
localStorage.setItem("ws5",$App.ws);
localStorage.setItem("wp5",$App.wp);
localStorage.setItem("nsd5",$App.nsd);
localStorage.setItem("che5",$App.che);
localStorage.setItem("tum5",$App.tum);
localStorage.setItem("llu5",$App.llu);
localStorage.setItem("lru5",$App.lru);
localStorage.setItem("aru5",$App.aru);
localStorage.setItem("alu5",$App.alu);
localStorage.setItem("bs5",$App.bs);
localStorage.setItem("bp5",$App.bp);};
$scope.PushButton10_click = function() {$App.recall = "5";
$App.save005 = localStorage.getItem("save005");
$App.recall2 = $App.save005;
$App.hi = localStorage.getItem("hi5");
$App.hf = localStorage.getItem("hf5");
$App.ws = localStorage.getItem("ws5");
$App.wp = localStorage.getItem("wp5");
$App.nsd = localStorage.getItem("nsd5");
$App.che = localStorage.getItem("che5");
$App.tum = localStorage.getItem("tum5");
$App.llu = localStorage.getItem("llu5");
$App.lru = localStorage.getItem("lru5");
$App.aru = localStorage.getItem("aru5");
$App.alu = localStorage.getItem("alu5");
$App.bp = localStorage.getItem("bp5");
$App.bs = localStorage.getItem("bs5");};
$scope.PushButton11_click = function() {$App.save006 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save006",$App.save006);
localStorage.setItem("hi6",$App.hi);
localStorage.setItem("hf6",$App.hf);
localStorage.setItem("ws6",$App.ws);
localStorage.setItem("wp6",$App.wp);
localStorage.setItem("nsd6",$App.nsd);
localStorage.setItem("che6",$App.che);
localStorage.setItem("tum6",$App.tum);
localStorage.setItem("llu6",$App.llu);
localStorage.setItem("lru6",$App.lru);
localStorage.setItem("aru6",$App.aru);
localStorage.setItem("alu6",$App.alu);
localStorage.setItem("bs6",$App.bs);
localStorage.setItem("bp6",$App.bp);};
$scope.PushButton12_click = function() {$App.recall = "6";
$App.save006 = localStorage.getItem("save006");
$App.recall2 = $App.save006;
$App.hi = localStorage.getItem("hi6");
$App.hf = localStorage.getItem("hf6");
$App.ws = localStorage.getItem("ws6");
$App.wp = localStorage.getItem("wp6");
$App.nsd = localStorage.getItem("nsd6");
$App.che = localStorage.getItem("che6");
$App.tum = localStorage.getItem("tum6");
$App.llu = localStorage.getItem("llu6");
$App.lru = localStorage.getItem("lru6");
$App.aru = localStorage.getItem("aru6");
$App.alu = localStorage.getItem("alu6");
$App.bp = localStorage.getItem("bp6");
$App.bs = localStorage.getItem("bs6");};
$scope.PushButton13_click = function() {$App.save007 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save007",$App.save007);
localStorage.setItem("hi7",$App.hi);
localStorage.setItem("hf7",$App.hf);
localStorage.setItem("ws7",$App.ws);
localStorage.setItem("wp7",$App.wp);
localStorage.setItem("nsd7",$App.nsd);
localStorage.setItem("che7",$App.che);
localStorage.setItem("tum7",$App.tum);
localStorage.setItem("llu7",$App.llu);
localStorage.setItem("lru7",$App.lru);
localStorage.setItem("aru7",$App.aru);
localStorage.setItem("alu7",$App.alu);
localStorage.setItem("bs7",$App.bs);
localStorage.setItem("bp7",$App.bp);};
$scope.PushButton14_click = function() {$App.recall = "7";
$App.save007 = localStorage.getItem("save007");
$App.recall2 = $App.save007;
$App.hi = localStorage.getItem("hi7");
$App.hf = localStorage.getItem("hf7");
$App.ws = localStorage.getItem("ws7");
$App.wp = localStorage.getItem("wp7");
$App.nsd = localStorage.getItem("nsd7");
$App.che = localStorage.getItem("che7");
$App.tum = localStorage.getItem("tum7");
$App.llu = localStorage.getItem("llu7");
$App.lru = localStorage.getItem("lru7");
$App.aru = localStorage.getItem("aru7");
$App.alu = localStorage.getItem("alu7");
$App.bp = localStorage.getItem("bp7");
$App.bs = localStorage.getItem("bs7");};
$scope.PushButton15_click = function() {$App.save008 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save008",$App.save008);
localStorage.setItem("hi8",$App.hi);
localStorage.setItem("hf8",$App.hf);
localStorage.setItem("ws8",$App.ws);
localStorage.setItem("wp8",$App.wp);
localStorage.setItem("nsd8",$App.nsd);
localStorage.setItem("che8",$App.che);
localStorage.setItem("tum8",$App.tum);
localStorage.setItem("llu8",$App.llu);
localStorage.setItem("lru8",$App.lru);
localStorage.setItem("aru8",$App.aru);
localStorage.setItem("alu8",$App.alu);
localStorage.setItem("bs8",$App.bs);
localStorage.setItem("bp8",$App.bp);};
$scope.PushButton16_click = function() {$App.recall = "8";
$App.save008 = localStorage.getItem("save008");
$App.recall2 = $App.save008;
$App.hi = localStorage.getItem("hi8");
$App.hf = localStorage.getItem("hf8");
$App.ws = localStorage.getItem("ws8");
$App.wp = localStorage.getItem("wp8");
$App.nsd = localStorage.getItem("nsd8");
$App.che = localStorage.getItem("che8");
$App.tum = localStorage.getItem("tum8");
$App.llu = localStorage.getItem("llu8");
$App.lru = localStorage.getItem("lru8");
$App.aru = localStorage.getItem("aru8");
$App.alu = localStorage.getItem("alu8");
$App.bp = localStorage.getItem("bp8");
$App.bs = localStorage.getItem("bs8");};
$scope.PushButton17_click = function() {$App.save009 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save009",$App.save009);
localStorage.setItem("hi9",$App.hi);
localStorage.setItem("hf9",$App.hf);
localStorage.setItem("ws9",$App.ws);
localStorage.setItem("wp9",$App.wp);
localStorage.setItem("nsd9",$App.nsd);
localStorage.setItem("che9",$App.che);
localStorage.setItem("tum9",$App.tum);
localStorage.setItem("llu9",$App.llu);
localStorage.setItem("lru9",$App.lru);
localStorage.setItem("aru9",$App.aru);
localStorage.setItem("alu9",$App.alu);
localStorage.setItem("bs9",$App.bs);
localStorage.setItem("bp9",$App.bp);};
$scope.PushButton18_click = function() {$App.recall = "9";
$App.save009 = localStorage.getItem("save009");
$App.recall2 = $App.save009;
$App.hi = localStorage.getItem("hi9");
$App.hf = localStorage.getItem("hf9");
$App.ws = localStorage.getItem("ws9");
$App.wp = localStorage.getItem("wp9");
$App.nsd = localStorage.getItem("nsd9");
$App.che = localStorage.getItem("che9");
$App.tum = localStorage.getItem("tum9");
$App.llu = localStorage.getItem("llu9");
$App.lru = localStorage.getItem("lru9");
$App.aru = localStorage.getItem("aru9");
$App.alu = localStorage.getItem("alu9");
$App.bp = localStorage.getItem("bp9");
$App.bs = localStorage.getItem("bs9");};
$scope.PushButton19_click = function() {$App.save0100 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save0100",$App.save0100);
localStorage.setItem("hi10",$App.hi);
localStorage.setItem("hf10",$App.hf);
localStorage.setItem("ws10",$App.ws);
localStorage.setItem("wp10",$App.wp);
localStorage.setItem("nsd10",$App.nsd);
localStorage.setItem("che10",$App.che);
localStorage.setItem("tum10",$App.tum);
localStorage.setItem("llu10",$App.llu);
localStorage.setItem("lru10",$App.lru);
localStorage.setItem("aru10",$App.aru);
localStorage.setItem("alu10",$App.alu);
localStorage.setItem("bs10",$App.bs);
localStorage.setItem("bp10",$App.bp);};
$scope.PushButton20_click = function() {$App.hi = "R";
$App.hf = "R";
$App.ws = "R";
$App.wp = "R";
$App.nsd = "R";
...
$App.bp = "R";
$App.bs = "R";
localStorage.setItem("save001","Set");
localStorage.setItem("save002","Set");
localStorage.setItem("save003","Set");
localStorage.setItem("save004","Set");
localStorage.setItem("save005","Set");
localStorage.setItem("save006","Set");
localStorage.setItem("save007","Set");
localStorage.setItem("save008","Set");
localStorage.setItem("save009","Set");
localStorage.setItem("save010","Set");};
$scope.PushButton41_click = function() {$App.recall = "10";
$App.save0010 = localStorage.getItem("save0010");
$App.recall2 = $App.save0010;
$App.hi = localStorage.getItem("hi10");
$App.hf = localStorage.getItem("hf10");
$App.ws = localStorage.getItem("ws10");
$App.wp = localStorage.getItem("wp10");
$App.nsd = localStorage.getItem("nsd10");
$App.che = localStorage.getItem("che10");
$App.tum = localStorage.getItem("tum10");
$App.llu = localStorage.getItem("llu10");
$App.lru = localStorage.getItem("lru10");
$App.aru = localStorage.getItem("aru10");
$App.alu = localStorage.getItem("alu10");
...
$App.NAB.PageID = "Page2";
$scope.TextInput12_change = function() {localStorage.setItem("nsd",$App.nsd);};
$scope.TextInput13_change = function() {localStorage.setItem("che",$App.che);};
$scope.TextInput14_change = function() {localStorage.setItem("tum",$App.tum);};
$scope.TextInput15_change = function() {localStorage.setItem("llu",$App.llu);};
$scope.TextInput16_change = function() {localStorage.setItem("lru",$App.lru);};
$scope.TextInput17_change = function() {localStorage.setItem("alu",$App.alu);};
$scope.TextInput18_change = function() {localStorage.setItem("aru",$App.aru);};
$scope.TextInput19_change = function() {localStorage.setItem("ws",$App.ws);};
$scope.TextInput20_change = function() {localStorage.setItem("wp",$App.wp);};
$scope.TextInput21_change = function() {localStorage.setItem("hf",$App.hf);};
$scope.TextInput22_change = function() {localStorage.setItem("hi",$App.hi);};
$scope.PushButton21_click = function() {$App.save001 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save001",$App.save001);
localStorage.setItem("hi1",$App.hi);
localStorage.setItem("hf1",$App.hf);
localStorage.setItem("ws1",$App.ws);
...
localStorage.setItem("aru1",$App.aru);
localStorage.setItem("alu1",$App.alu);};
$scope.PushButton22_click = function() {$App.recall = "1";
$App.recall2 = $App.save001;
$App.save001 = localStorage.getItem("save001");
$App.hi = localStorage.getItem("hi1");
$App.hf = localStorage.getItem("hf1");
...
$App.aru = localStorage.getItem("aru1");
$App.alu = localStorage.getItem("alu1");};
$scope.PushButton23_click = function() {$App.save002 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save002",$App.save002);
localStorage.setItem("hi2",$App.hi);
localStorage.setItem("hf2",$App.hf);
localStorage.setItem("ws2",$App.ws);
...
localStorage.setItem("aru2",$App.aru);
localStorage.setItem("alu2",$App.alu);};
$scope.PushButton24_click = function() {$App.recall = "2";
$App.save002 = localStorage.getItem("save002");
$App.recall2 = $App.save002;
$App.hi = localStorage.getItem("hi2");
$App.hf = localStorage.getItem("hf2");
...
$App.aru = localStorage.getItem("aru2");
$App.alu = localStorage.getItem("alu2");};
$scope.PushButton25_click = function() {$App.save003 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save003",$App.save003);
localStorage.setItem("hi3",$App.hi);
localStorage.setItem("hf3",$App.hf);
localStorage.setItem("ws3",$App.ws);
...
localStorage.setItem("aru3",$App.aru);
localStorage.setItem("alu3",$App.alu);};
$scope.PushButton26_click = function() {$App.recall = "3";
$App.save003 = localStorage.getItem("save003");
$App.recall2 = $App.save003;
$App.hi = localStorage.getItem("hi3");
$App.hf = localStorage.getItem("hf3");
...
$App.aru = localStorage.getItem("aru3");
$App.alu = localStorage.getItem("alu3");};
$scope.PushButton27_click = function() {$App.save004 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save004",$App.save004);
localStorage.setItem("hi4",$App.hi);
localStorage.setItem("hf4",$App.hf);
localStorage.setItem("ws4",$App.ws);
...
localStorage.setItem("aru4",$App.aru);
localStorage.setItem("alu4",$App.alu);};
$scope.PushButton28_click = function() {$App.recall = "4";
$App.save004 = localStorage.getItem("save004");
$App.recall2 = $App.save004;
$App.hi = localStorage.getItem("hi4");
$App.hf = localStorage.getItem("hf4");
...
$App.aru = localStorage.getItem("aru4");
$App.alu = localStorage.getItem("alu4");};
$scope.PushButton29_click = function() {$App.save005 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save005",$App.save005);
localStorage.setItem("hi5",$App.hi);
localStorage.setItem("hf5",$App.hf);
localStorage.setItem("ws5",$App.ws);
...
localStorage.setItem("aru5",$App.aru);
localStorage.setItem("alu5",$App.alu);};
$scope.PushButton30_click = function() {$App.recall = "5";
$App.save005 = localStorage.getItem("save005");
$App.recall2 = $App.save005;
$App.hi = localStorage.getItem("hi5");
$App.hf = localStorage.getItem("hf5");
...
$App.aru = localStorage.getItem("aru5");
$App.alu = localStorage.getItem("alu5");};
$scope.PushButton31_click = function() {$App.save006 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save006",$App.save006);
localStorage.setItem("hi6",$App.hi);
localStorage.setItem("hf6",$App.hf);
localStorage.setItem("ws6",$App.ws);
...
localStorage.setItem("aru6",$App.aru);
localStorage.setItem("alu6",$App.alu);};
$scope.PushButton32_click = function() {$App.recall = "6";
$App.save006 = localStorage.getItem("save006");
$App.recall2 = $App.save006;
$App.hi = localStorage.getItem("hi6");
$App.hf = localStorage.getItem("hf6");
...
$App.aru = localStorage.getItem("aru6");
$App.alu = localStorage.getItem("alu6");};
$scope.PushButton33_click = function() {$App.save007 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save007",$App.save007);
localStorage.setItem("hi7",$App.hi);
localStorage.setItem("hf7",$App.hf);
localStorage.setItem("ws7",$App.ws);
...
localStorage.setItem("aru7",$App.aru);
localStorage.setItem("alu7",$App.alu);};
$scope.PushButton34_click = function() {$App.recall = "7";
$App.save007 = localStorage.getItem("save007");
$App.recall2 = $App.save007;
$App.hi = localStorage.getItem("hi7");
$App.hf = localStorage.getItem("hf7");
...
$App.aru = localStorage.getItem("aru7");
$App.alu = localStorage.getItem("alu7");};
$scope.PushButton35_click = function() {$App.save008 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save008",$App.save008);
localStorage.setItem("hi8",$App.hi);
localStorage.setItem("hf8",$App.hf);
localStorage.setItem("ws8",$App.ws);
...
localStorage.setItem("aru8",$App.aru);
localStorage.setItem("alu8",$App.alu);};
$scope.PushButton36_click = function() {$App.recall = "8";
$App.save008 = localStorage.getItem("save008");
$App.recall2 = $App.save008;
$App.hi = localStorage.getItem("hi8");
$App.hf = localStorage.getItem("hf8");
...
$App.aru = localStorage.getItem("aru8");
$App.alu = localStorage.getItem("alu8");};
$scope.PushButton37_click = function() {$App.save009 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save009",$App.save009);
localStorage.setItem("hi9",$App.hi);
localStorage.setItem("hf9",$App.hf);
localStorage.setItem("ws9",$App.ws);
...
localStorage.setItem("aru9",$App.aru);
localStorage.setItem("alu9",$App.alu);};
$scope.PushButton38_click = function() {$App.recall = "9";
$App.save009 = localStorage.getItem("save009");
$App.recall2 = $App.save009;
$App.hi = localStorage.getItem("hi9");
$App.hf = localStorage.getItem("hf9");
...
$App.aru = localStorage.getItem("aru9");
$App.alu = localStorage.getItem("alu9");};
$scope.PushButton39_click = function() {$App.save0100 = $App.NAB.DayNum+" "+$App.NAB.Month+" "+$App.NAB.Year;
localStorage.setItem("save0100",$App.save0100);
localStorage.setItem("hi10",$App.hi);
localStorage.setItem("hf10",$App.hf);
localStorage.setItem("ws10",$App.ws);
...
localStorage.setItem("aru10",$App.aru);
localStorage.setItem("alu10",$App.alu);};
$scope.PushButton40_click = function() {localStorage.setItem("hi1",$App.o);
localStorage.setItem("hf1",$App.o);
localStorage.setItem("ws1",$App.o);
localStorage.setItem("wp1",$App.o);
localStorage.setItem("nsd1",$App.o);
localStorage.setItem("che1",$App.o);
localStorage.setItem("tum1",$App.o);
localStorage.setItem("llu1",$App.o);
localStorage.setItem("lru1",$App.o);
localStorage.setItem("aru1",$App.o);
localStorage.setItem("alu1",$App.o);
localStorage.setItem("save001","Set");
localStorage.setItem("save002","Set");
localStorage.setItem("save003","Set");
localStorage.setItem("save004","Set");
